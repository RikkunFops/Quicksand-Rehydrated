...
public class ModSurfaceRules {
    ...
    public static SurfaceRules.RuleSource MakeRules() {
        var noise_1 = ResourceKey.create(Registries.NOISE, ResourceLocation.fromNamespaceAndPath(QuicksandRehydrated.MOD_ID, "mudflat_noise"));
        var noise_2 = ResourceKey.create(Registries.NOISE, ResourceLocation.fromNamespaceAndPath(QuicksandRehydrated.MOD_ID, "mudflat_noise_2"));
