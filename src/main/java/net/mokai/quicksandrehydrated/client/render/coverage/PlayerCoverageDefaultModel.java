...
public class PlayerCoverageDefaultModel<T extends LivingEntity> extends HumanoidModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("qsrehydrated", "coverage_layer_default"), "coverage_default");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        ...
        this.hat.render(poseStack, vertexConsumer, packedLight, packedOverlay);
    }
}
