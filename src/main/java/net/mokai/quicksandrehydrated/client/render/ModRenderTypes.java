...
public class ModRenderTypes
{
    ...
    public static final ResourceLocation COVERAGE_MASK_LOCATION = ResourceLocation.fromNamespaceAndPath(QuicksandRehydrated.MOD_ID,"textures/entity/coverage/coverage_mask.png");
    public static final ResourceLocation DUMMY_TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(QuicksandRehydrated.MOD_ID, "na");
