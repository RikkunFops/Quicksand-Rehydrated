...
public class PlayerCoverageSlimModel<T extends LivingEntity> extends PlayerCoverageDefaultModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("qsrehydrated", "coverage_layer_default"), "coverage_slim");
