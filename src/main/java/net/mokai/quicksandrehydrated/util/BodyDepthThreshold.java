...
public enum BodyDepthThreshold {
     ...
     * Beginning from <code>0</code> (<code>GROUND</code>) to <code>8</code> (<code>UNDER</code>).
     */
     ...
     * <p><code>height</code> in ]<code>KNEE</code>;<code>THIGH</code>]: returns <code>THIGH</code></p>
    ...
    public static BodyDepthThreshold fromHeight(double height) {
        ...
        if (height <= BodyDepthThreshold.WAIST.depth)
            return WAIST;
        if (height <= BodyDepthThreshold.ABDOMEN.depth)
            return ABDOMEN;
